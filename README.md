...
- FastAPI backend skeleton с `/health` endpoint.

Таймеры всё ещё работают через mock-реализацию в `frontend/src/services/timerService.ts`. Backend mutations таймеров пока не подключены.
